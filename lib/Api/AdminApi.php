...
class AdminApi
{
    ...
    {
        list($response) = $this->availablePlansWithHttpInfo();
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\APIPlansOut, HTTP status code, HTTP response headers (array of strings)
     */
    public function availablePlansWithHttpInfo()
    {
        $request = $this->availablePlansRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function availablePlansAsync()
    {
        return $this->availablePlansAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function availablePlansAsyncWithHttpInfo()
    {
        $returnType = '\OpenAPI\Client\Model\APIPlansOut';
        $request = $this->availablePlansRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function availablePlansRequest()
    {
     ...
     * @return \OpenAPI\Client\Model\APIPlansOut
     */
    public function availablePlans1($token)
    {
        list($response) = $this->availablePlans1WithHttpInfo($token);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\APIPlansOut, HTTP status code, HTTP response headers (array of strings)
     */
    public function availablePlans1WithHttpInfo($token)
    {
        $request = $this->availablePlans1Request($token);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function availablePlans1Async($token)
    {
        return $this->availablePlans1AsyncWithHttpInfo($token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function availablePlans1AsyncWithHttpInfo($token)
    {
        $returnType = '\OpenAPI\Client\Model\APIPlansOut';
        $request = $this->availablePlans1Request($token);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function availablePlans1Request($token)
    {
        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling availablePlans1'
            );
        }
     ...
     * @return void
     */
    public function redeployUI()
    {
        $this->redeployUIWithHttpInfo();
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function redeployUIWithHttpInfo()
    {
        $request = $this->redeployUIRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redeployUIAsync()
    {
        return $this->redeployUIAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redeployUIAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->redeployUIRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function redeployUIRequest()
    {
     ...
     * @return void
     */
    public function redeployUI1($live)
    {
        $this->redeployUI1WithHttpInfo($live);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function redeployUI1WithHttpInfo($live)
    {
        $request = $this->redeployUI1Request($live);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redeployUI1Async($live)
    {
        return $this->redeployUI1AsyncWithHttpInfo($live)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function redeployUI1AsyncWithHttpInfo($live)
    {
        $returnType = '';
        $request = $this->redeployUI1Request($live);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function redeployUI1Request($live)
    {
        // verify the required parameter 'live' is set
        if ($live === null || (is_array($live) && count($live) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $live when calling redeployUI1'
            );
        }
